...
def id_song(stream_url=None):
    ...
    def capture_sample_from_stream(stream_url, duration_sec, output_file="sample.wav"):
        """
    ...
    capture_sample_from_stream(stream_url, duration_sec=21, output_file=sample_file)
